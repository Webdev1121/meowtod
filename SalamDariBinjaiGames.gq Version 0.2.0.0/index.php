...
<head>
    ...
    <title>Salam Dari Binjai Game</title>

    <link rel="stylesheet" href="https://salamdaribinjaigames.gq/bootstrap.min.css" />
</head>
...
<marquee><p>WARNING! SCORE & COINS WILL BE RESETED AFTER YOU CLOSE / REFRESH!</p></marquee>
<p>Signed In As <?php echo  $_SESSION["user"]["name"] ?></p>
<a href="https://salamdaribinjaigames.gq/logout.php">Log Out</a>
...
<h4 style="color= blue;"><big><bold>Click the banana tree to get score & coins!</h4></big>
        <body>

<audio id="audio" src="https://salamdaribinjaigames.gq/Play/sound/sound.wav"></audio>
<a href="#" id="play">
<img id="pisang" src="https://salamdaribinjaigames.gq/Play/img/imgpisang.png" height="200" width="190" />
</a>
<p>

</p>
<p>| 2021 Skymine Studios Game | <a href="https://www.skyminestudios.ml" target="_blank">Skymine Studios Website</a> |</p>
<a href="https://salamdaribinjaigames.gq/new/" target="_blank">|=| What's New? |=|</a> 
<a href="https://salamdaribinjaigames.gq/insight/" target="_blank">|=| Insights |=|</a> 
<a href="https://salamdaribinjaigames.gq/for-developers/" target="_blank">|=| For Developers |=|</a>
</button>
</body> 
</center>
       
  <div class="alert text-center cookiealert show" role="alert">
    <b>Do you like cookies?</b> 🍪 We use cookies to ensure you get the best experience on our website. <a href="https://en.wikipedia.org/wiki/HTTP_cookies/" target="_blank">Learn more</a>
...
<style>
@import url('https://fonts.googleapis.com/css2?family=Comic+Neue:wght@300&family=Shippori+Antique+B1&display=swap');
<style>

    <style>

div {
  background-image: url('https://salamdaribinjaigames.gq/Play/img/background.webp');
}
...
<script>
 (function() {
                var score = 0;
                var phone = document.getElementById("pisang");
...
document.getElementById("pisang").addEventListener("click", function(){
